...
// Use local test fixture instead of fetching from remote API
const fixtureFile = path.join(import.meta.dirname, "tool/fixtures/models-api.json")
const fixtureData = await fs.readFile(fixtureFile, "utf-8")
await fs.writeFile(path.join(cacheDir, "models.json"), fixtureData)
