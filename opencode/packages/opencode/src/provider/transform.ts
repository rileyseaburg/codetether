...
export namespace ProviderTransform {
  ...
  export function temperature(model: Provider.Model) {
    ...
    if (id.includes("kimi-k2")) {
      // kimi-k2.5 and kimi-k2 thinking models use fixed temperature 1.0
      // kimi-k2.5 non-thinking uses fixed 0.6
  ...
  export function topP(model: Provider.Model) {
    ...
    // kimi-k2.5 uses fixed top_p 0.95
  ...
  export function variants(model: Provider.Model): Record<string, Record<string, any>> {
    ...
    // Kimi K2.5 supports thinking (enabled by default) and non-thinking modes
  ...
  export function options(input: {
    ...
    // Kimi K2.5 thinking mode - enabled by default per Moonshot API docs
    if (input.model.api.id === "kimi-k2.5" || input.model.api.id.includes("kimi-k2.5")) {
