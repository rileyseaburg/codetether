...
const TIPS = [
  ...
  "Use RLM ({highlight}Ctrl+Alt+R{/highlight}) for intelligent context compression of large conversations",
  "RLM uses recursive sub-calls to preserve important context while compressing",
