...
import type {
  ...
  SessionRlmErrors,
  SessionRlmResponses,
  SessionRlmTraceErrors,
  SessionRlmTraceResponses,
  SessionShareErrors,
...
export class Session extends HeyApiClient {
  ...
  /**
   * RLM compress session
   *
   * Compress session context using RLM (Recursive Language Model) for handling large conversations.
   */
  public rlm<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
      directory?: string
      providerID?: string
    ...
    return (options?.client ?? this.client).post<SessionRlmResponses, SessionRlmErrors, ThrowOnError>({
   ...
   * Get RLM traces
   *
   * Get recent RLM execution traces for a session, useful for debugging context compression.
   */
  public rlmTrace<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
      directory?: string
    },
    ...
    return (options?.client ?? this.client).get<SessionRlmTraceResponses, SessionRlmTraceErrors, ThrowOnError>({
