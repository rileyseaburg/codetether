    ...
    return (
        ...
        >
            <div className="p-3 sm:p-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between gap-3 shrink-0">
                ...
                <div className="flex flex-col flex-1 min-w-0 max-w-48 sm:max-w-56">
                    ...
                    <select
                        ...
                        className="min-w-0 rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 w-full"
            ...
            >
                {sessions.length === 0 ? (
                    <div className="p-6 sm:p-8 text-center text-gray-500" role="status" aria-live="polite">
