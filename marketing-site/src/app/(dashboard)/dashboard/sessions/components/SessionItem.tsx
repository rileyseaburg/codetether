...
export function SessionItem({ session, isSelected, onSelect }: SessionItemProps) {
    ...
    return (
        <button
            ...
            className={`w-full text-left p-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500 ${isSelected ? 'bg-indigo-50 dark:bg-indigo-900/20' : ''}`}
