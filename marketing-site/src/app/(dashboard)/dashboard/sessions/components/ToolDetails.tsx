...
export function ToolDetails({ tools, isUser }: ToolDetailsProps) {
    ...
    return (
        <details
            className={`mt-3 rounded-lg ${isUser ? 'bg-indigo-500/20' : 'bg-blue-50 dark:bg-blue-900/20 ring-1 ring-blue-200/50 dark:ring-blue-700/30'}`}
            onToggle={(e) => setIsOpen((e.target as HTMLDetailsElement).open)}
        >
            <summary
                className="cursor-pointer select-none p-3 text-xs font-medium text-blue-800 dark:text-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded-lg flex items-center justify-between gap-2"
