...
export const PythonSettings_ExperimentalFeatures = {
  encode(message: PythonSettings_ExperimentalFeatures, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
...
export const GoSettings = {
  encode(message: GoSettings, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    Object.entries(message.renamedServices).forEach(([key, value]) => {
      GoSettings_RenamedServicesEntry.encode({ key: key as any, value }, writer.uint32(18).fork()).ldelim();
    });
    return writer;
  },
...
export const GoSettings_RenamedServicesEntry = {
  encode(message: GoSettings_RenamedServicesEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GoSettings_RenamedServicesEntry {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SelectiveGapicGeneration = {
  encode(message: SelectiveGapicGeneration, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
